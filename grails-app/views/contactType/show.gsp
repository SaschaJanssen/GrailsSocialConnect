...
<%@ page import="org.social.grails.customer.ContactType" %>
<!doctype html>
<html>
	<head>
	...
	<body>
		<a href="#show-contactType" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="show-contactType" class="content scaffold-show" role="main">
			...
			<ol class="property-list contactType">
				...
				<li class="fieldcontain">
					<span id="dateCreated-label" class="property-label"><g:message code="contactType.dateCreated.label" default="Date Created" /></span>
				...
				<li class="fieldcontain">
					<span id="lastUpdated-label" class="property-label"><g:message code="contactType.lastUpdated.label" default="Last Updated" /></span>
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="edit" id="${contactTypeInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
