...
public class ZagatQuery extends Query {
    ...
    public ZagatQuery(CustomerNetworkKeywords customerNetworkKeywords) {
        ...
        searchUrl = UtilProperties.getPropertyValue("grails-app/conf/network/zagat.properties", "searchUrl");
        postFix = UtilProperties.getPropertyValue("grails-app/conf/network/zagat.properties", "postfix");
    }
